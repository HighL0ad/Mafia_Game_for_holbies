...
const TRANSLATIONS = {
    az: {
        ...
        fix_role_balance: "Rol balansını düzəldin",
        invalid_initial_balance_mafia: "Oyuna başlamaq olmaz: Mafiyanın sayı digər oyunçuların ümumi sayından az olmalıdır.",
        invalid_initial_balance_town: "Oyuna başlamaq olmaz: Mafiya və ya Manyak əlavə edin, əks halda şəhər artıq qalib sayılır.",
        invalid_initial_balance_maniac: "Oyuna başlamaq olmaz: Manyak artıq qələbə şərtini yerinə yetirib. Daha çox şəhər sakini və ya Mafiya əlavə edin.",
        invalid_role_count: "Rol sayı düzgün göstərilməyib.",
        roles_count_mismatch: "Rolların sayı oyunçuların sayına bərabər olmalıdır.",
        game_started_join_error: "Oyun artıq başlayıb. Yalnız əvvəl qoşulmuş oyunçu öz adı ilə geri qayıda bilər.",
        game_finished_join_error: "Bu oyun artıq başa çatıb. Yeni iştirakçı qoşula bilməz.",
        ...
        doctor_night_title: "Həkim müdafiəsi",
        doctor_night_subtitle: "Bu gecə qorumaq istədiyiniz oyunçunu seçin.",
        doctor_target_selected: "Həkimin müdafiə hədəfi seçildi",
        doctor_saved_city: "Həkim bu gecə bir şəhər sakinini xilas etdi!",
        you_were_saved_title: "Həkim sizi xilas etdi!",
        you_were_saved_desc: "Bu gecə hücuma məruz qaldınız, lakin Həkimin müdafiəsi sizi oyunda saxladı.",
        sheriff_night_title: "Şerif araşdırması",
        sheriff_night_subtitle: "Dosyesini yoxlamaq istədiyiniz oyunçunu seçin.",
        sheriff_result_mafia: "Mafiya üzvüdür",
        sheriff_result_civilian: "Dinc sakindir",
        maniac_night_title: "Manyakın ovu",
        maniac_night_subtitle: "Bu gecə aradan qaldırmaq istədiyiniz oyunçunu seçin.",
        maniac_target_selected: "Manyak hədəfini seçdi",
        don_check_title: "Donun Şerif axtarışı",
        don_check_subtitle: "Şerif olduğunu düşündüyünüz oyunçunu yoxlayın.",
        don_result_sheriff: "Şerifdir",
        don_result_not_sheriff: "Şerif deyil",
        investigation_complete: "Gizli dosye açıldı",
        doctor_target_label: "Həkimin müdafiəsi",
        sheriff_target_label: "Şerifin yoxlaması",
        maniac_target_label: "Manyakın hədəfi",
        don_check_target_label: "Donun yoxlaması",
        night_actions_progress: "Hazır gecə rolları",
        night_open_actions: "Gecə hərəkətləri",
        waiting_night_choice: "Seçim gözlənilir...",
        night_victims_prefix: "Bu gecə həlak olanlar:",
        night_no_targets: "Uyğun hədəf yoxdur",
        you_label: "siz",
        invalid_night_action: "Gecə hərəkəti göndərilmədi",
        night_action_wrong_phase: "Bu hərəkət yalnız gecə mümkündür",
        night_action_forbidden: "Bu gecə hərəkəti rolunuz üçün mövcud deyil",
        night_action_invalid_target: "Bu hədəf artıq mövcud deyil",
        night_action_self_forbidden: "Özünüzü hədəf seçə bilməzsiniz",
        mafia_friendly_fire_forbidden: "Mafiya öz üzvünü hədəf seçə bilməz",
        doctor_self_consecutive_error: "Həkim özünü iki gecə ardıcıl qoruya bilməz",
        night_investigation_locked: "Bu gecə araşdırma artıq tamamlanıb",
        you_were_shot_title: "SİZ BU GECƏ GÜLLƏLƏNDİNİZ!",
        you_were_shot_desc: "Bu gecə hücuma məruz qaldınız və oyundan çıxarıldınız.",
    ...
    ru: {
        ...
        fix_role_balance: "Исправьте баланс ролей",
        invalid_initial_balance_mafia: "Нельзя начать игру: мафии должно быть меньше, чем всех остальных игроков вместе.",
        invalid_initial_balance_town: "Нельзя начать игру без Мафии или Маньяка: город уже считается победителем.",
        invalid_initial_balance_maniac: "Нельзя начать игру: Маньяк уже выполнил условие победы. Добавьте больше мирных или Мафию.",
        invalid_role_count: "Указано некорректное количество ролей.",
        roles_count_mismatch: "Количество ролей должно совпадать с количеством игроков.",
        game_started_join_error: "Игра уже началась. Вернуться может только ранее подключённый игрок под своим именем.",
        game_finished_join_error: "Эта игра уже завершена. Новый участник не может присоединиться.",
        ...
        doctor_night_title: "Защита Доктора",
        doctor_night_subtitle: "Выберите игрока, которого хотите защитить этой ночью.",
        doctor_target_selected: "Пациент Доктора выбран",
        doctor_saved_city: "Доктор спас жителя этой ночью!",
        you_were_saved_title: "Доктор спас вас!",
        you_were_saved_desc: "Этой ночью на вас напали, но защита Доктора оставила вас в игре.",
        sheriff_night_title: "Расследование Шерифа",
        sheriff_night_subtitle: "Выберите игрока, чьё досье хотите проверить.",
        sheriff_result_mafia: "Член Мафии",
        sheriff_result_civilian: "Мирный житель",
        maniac_night_title: "Охота Маньяка",
        maniac_night_subtitle: "Выберите цель для ликвидации этой ночью.",
        maniac_target_selected: "Цель Маньяка выбрана",
        don_check_title: "Поиск Шерифа Доном",
        don_check_subtitle: "Проверьте игрока, которого считаете Шерифом.",
        don_result_sheriff: "Шериф",
        don_result_not_sheriff: "Не Шериф",
        investigation_complete: "Секретное досье открыто",
        doctor_target_label: "Защита Доктора",
        sheriff_target_label: "Проверка Шерифа",
        maniac_target_label: "Цель Маньяка",
        don_check_target_label: "Проверка Дона",
        night_actions_progress: "Готовность ночных ролей",
        night_open_actions: "Ночные действия",
        waiting_night_choice: "Ожидается выбор...",
        night_victims_prefix: "Этой ночью погибли:",
        night_no_targets: "Нет доступных целей",
        you_label: "вы",
        invalid_night_action: "Ночное действие не отправлено",
        night_action_wrong_phase: "Это действие доступно только ночью",
        night_action_forbidden: "Это ночное действие недоступно вашей роли",
        night_action_invalid_target: "Эта цель больше недоступна",
        night_action_self_forbidden: "Нельзя выбрать себя целью",
        mafia_friendly_fire_forbidden: "Мафия не может выбрать своего участника",
        doctor_self_consecutive_error: "Доктор не может лечить себя две ночи подряд",
        night_investigation_locked: "Расследование этой ночи уже завершено",
        you_were_shot_title: "ВАС ЗАСТРЕЛИЛИ ЭТОЙ НОЧЬЮ!",
        you_were_shot_desc: "Этой ночью на вас напали, и вы выбыли из игры.",
    ...
    en: {
        ...
        fix_role_balance: "Fix role balance",
        invalid_initial_balance_mafia: "The game cannot start: Mafia must be fewer than all other players combined.",
        invalid_initial_balance_town: "The game cannot start without Mafia or a Maniac: the town would already be the winner.",
        invalid_initial_balance_maniac: "The game cannot start: the Maniac already meets the win condition. Add more town players or Mafia.",
        invalid_role_count: "The role count is invalid.",
        roles_count_mismatch: "The number of roles must match the number of players.",
        game_started_join_error: "The game has already started. Only an existing player can return using their original name.",
        game_finished_join_error: "This game has already ended. A new player cannot join.",
        ...
        doctor_night_title: "Doctor Protection",
        doctor_night_subtitle: "Choose the player you want to protect tonight.",
        doctor_target_selected: "Doctor's patient selected",
        doctor_saved_city: "The Doctor saved a resident tonight!",
        you_were_saved_title: "The Doctor saved you!",
        you_were_saved_desc: "You were attacked tonight, but the Doctor's protection kept you in the game.",
        sheriff_night_title: "Sheriff Investigation",
        sheriff_night_subtitle: "Choose the player whose dossier you want to inspect.",
        sheriff_result_mafia: "Mafia Member",
        sheriff_result_civilian: "Civilian",
        maniac_night_title: "Maniac Hunt",
        maniac_night_subtitle: "Choose a target to eliminate tonight.",
        maniac_target_selected: "Maniac target selected",
        don_check_title: "Don's Sheriff Search",
        don_check_subtitle: "Check the player you suspect is the Sheriff.",
        don_result_sheriff: "Sheriff",
        don_result_not_sheriff: "Not the Sheriff",
        investigation_complete: "Confidential dossier opened",
        doctor_target_label: "Doctor Protection",
        sheriff_target_label: "Sheriff Check",
        maniac_target_label: "Maniac Target",
        don_check_target_label: "Don Check",
        night_actions_progress: "Night role readiness",
        night_open_actions: "Night actions",
        waiting_night_choice: "Waiting for choice...",
        night_victims_prefix: "Killed tonight:",
        night_no_targets: "No available targets",
        you_label: "you",
        invalid_night_action: "Night action was not submitted",
        night_action_wrong_phase: "This action is only available at night",
        night_action_forbidden: "This night action is not available to your role",
        night_action_invalid_target: "This target is no longer available",
        night_action_self_forbidden: "You cannot target yourself",
        mafia_friendly_fire_forbidden: "Mafia cannot target a team member",
        doctor_self_consecutive_error: "The Doctor cannot protect themselves two nights in a row",
        night_investigation_locked: "Tonight's investigation is already complete",
        you_were_shot_title: "YOU WERE SHOT TONIGHT!",
        you_were_shot_desc: "You were attacked and eliminated tonight.",
